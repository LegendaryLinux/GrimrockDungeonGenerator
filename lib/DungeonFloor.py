...
class DungeonFloor:
    ...
    def determine_room_placement(self, width, height, alcove_size):
    ...
    def place_room(self, x_pos, y_pos, width, height, alcove_placement, alcove_size):
        occupied_grids = []
        alcove_grids = []
